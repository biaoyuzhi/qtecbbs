...
//      console.log(bean);
      ...
      fly.json("/jie/save",{
          ...
          layer.msg("发布成功",{time:2000},function (data) {
  ...
  form.on('submit(jie-reply)', function(data){
      ...
      fly.json("/comment/save",{
          ...
          layer.msg("回复成功",{time:2000},function (data) {
